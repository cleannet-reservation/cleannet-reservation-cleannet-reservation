  ...
  services: [
    {
      ...
      options: [
        { id: "c1", label: "2 places", price: 89 },
        { id: "c2", label: "3 places", price: 109 },
        { id: "c3", label: "Canapé d'angle", price: 139 },
      ],
    },
    {
      ...
      options: [
        { id: "m1", label: "1 personne (90×190)", price: 69 },
        { id: "m2", label: "2 personnes (140×190)", price: 89 },
        { id: "m3", label: "King size (160×200+)", price: 109 },
      ],
    },
    {
      ...
      options: [
        { id: "v1", label: "Citadine / Berline", price: 79 },
        { id: "v2", label: "SUV / Monospace", price: 99 },
        { id: "v3", label: "Van / Utilitaire", price: 129 },
      ],
    },
    {
      ...
      options: [
        { id: "ch1", label: "Jusqu'à 50 m²", price: 149 },
        { id: "ch2", label: "50 à 100 m²", price: 249 },
        { id: "ch3", label: "100 à 200 m²", price: 399 },
      ],
    },
    {
      ...
      options: [
        { id: "vi1", label: "Appartement (≤ 80 m²)", price: 59 },
        { id: "vi2", label: "Maison (≤ 150 m²)", price: 99 },
        { id: "vi3", label: "Commerce / Bureau", price: 129 },
      ],
    },
    {
      ...
      options: [
        { id: "mo1", label: "À la pièce", price: 49 },
        { id: "mo2", label: "Forfait 3 pièces", price: 129 },
        { id: "mo3", label: "Forfait 5 pièces", price: 199 },
      ],
    },
  ],
  upsells: [],
...
function BookingFlow({ config }) {
  ...
  const canNext = () => {
    ...
    if (step === 2) return !!(form.prenom && form.nom && form.email && form.telephone && form.adresse && form.date);
    return true;
  };
        ...
        {step === 3 && (
          <>
            ...
            <button onClick={() => setConfirmed(true)}
              style={{ width: "100%", background: color, color: "#fff", border: "none", borderRadius: 10, padding: 16, fontSize: 15, fontWeight: 800, cursor: "pointer" }}>
              Confirmer et payer l'acompte — {fmt(acompte)}
            </button>
              ...
              {cfg.services.map((svc, si) => (
                <div key={svc.id} style={{ border: "1.5px solid #E5E7EB", borderRadius: 12, overflow: "hidden" }}>
                  ...
                  <div style={{ padding: "12px 16px" }}>
                    ...
                    <p style={{ fontSize: 12, fontWeight: 700, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: "0.5px", margin: "14px 0 8px" }}>Options & Prix</p>
